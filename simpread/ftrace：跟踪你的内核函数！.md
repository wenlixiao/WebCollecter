> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [linux.cn](https://linux.cn/article-9273-1-rel.html) 作者： [Julia Evans](https://jvns.ca/blog/2017/03/19/getting-started-with-ftrace/) 译者： [LCTT](https://linux.cn/lctt/) [qhwdw](/lctt/qhwdw)

| 2018-01-24 11:46   评论: [_1_](portal.php?mod=comment&id=9273&idtype=aid "查看全部评论") 收藏: _3_    
...
我们看到在这个示例中，在 `futex_wake` 后面调用了 `get_futex_key`。这是在源代码中真实发生的事情吗？我们可以检查一下！！[这里是在 Linux 4.4 中 futex_wake 的定义](https://github.com/torvalds/linux/blob/v4.4/kernel/futex.c#L1313-L1324) (我的内核版本是 4.4）。
...
via: [https://jvns.ca/blog/2017/03/19/getting-started-with-ftrace/](https://jvns.ca/blog/2017/03/19/getting-started-with-ftrace/)
